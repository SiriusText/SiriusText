		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getContainerChildrenPresentationAccess().getAlternatives(), "rule__ContainerChildrenPresentation__Alternatives");
					put(grammarAccess.getNodeLabelBorderStyleAccess().getAlternatives(), "rule__NodeLabelBorderStyle__Alternatives");
					put(grammarAccess.getLabelFormatOptionAccess().getAlternatives(), "rule__LabelFormatOption__Alternatives");
					put(grammarAccess.getLabelAlignmentAccess().getAlternatives(), "rule__LabelAlignment__Alternatives");
					put(grammarAccess.getContainerLabelBorderStyleAccess().getAlternatives(), "rule__ContainerLabelBorderStyle__Alternatives");
					...
					put(grammarAccess.getViewpointAccess().getGroup_1(), "rule__Viewpoint__Group_1__0");
					...
					put(grammarAccess.getViewpointAccess().getGroup_6_4(), "rule__Viewpoint__Group_6_4__0");
					...
					put(grammarAccess.getDiagramAccess().getGroup_10(), "rule__Diagram__Group_10__0");
					put(grammarAccess.getDiagramAccess().getGroup_12(), "rule__Diagram__Group_12__0");
					put(grammarAccess.getDiagramAccess().getGroup_13(), "rule__Diagram__Group_13__0");
					put(grammarAccess.getDiagramAccess().getGroup_14(), "rule__Diagram__Group_14__0");
					put(grammarAccess.getDiagramAccess().getGroup_15(), "rule__Diagram__Group_15__0");
					put(grammarAccess.getDiagramAccess().getGroup_16(), "rule__Diagram__Group_16__0");
					put(grammarAccess.getDiagramAccess().getGroup_16_3(), "rule__Diagram__Group_16_3__0");
					put(grammarAccess.getDiagramAccess().getGroup_16_3_1(), "rule__Diagram__Group_16_3_1__0");
					...
					put(grammarAccess.getContainerCreationAccess().getGroup_2(), "rule__ContainerCreation__Group_2__0");
					put(grammarAccess.getContainerCreationAccess().getGroup_3(), "rule__ContainerCreation__Group_3__0");
					put(grammarAccess.getContainerCreationAccess().getGroup_4(), "rule__ContainerCreation__Group_4__0");
					put(grammarAccess.getContainerCreationAccess().getGroup_7(), "rule__ContainerCreation__Group_7__0");
					put(grammarAccess.getContainerCreationAccess().getGroup_8(), "rule__ContainerCreation__Group_8__0");
					put(grammarAccess.getContainerCreationAccess().getGroup_13(), "rule__ContainerCreation__Group_13__0");
					put(grammarAccess.getContainerCreationAccess().getGroup_13_1(), "rule__ContainerCreation__Group_13_1__0");
					put(grammarAccess.getContainerCreationAccess().getGroup_15(), "rule__ContainerCreation__Group_15__0");
					put(grammarAccess.getContainerCreationAccess().getGroup_15_3(), "rule__ContainerCreation__Group_15_3__0");
					put(grammarAccess.getContainerCreationAccess().getGroup_15_3_1(), "rule__ContainerCreation__Group_15_3_1__0");
					...
					put(grammarAccess.getConditionalNodeStyleDeclarationAccess().getGroup(), "rule__ConditionalNodeStyleDeclaration__Group__0");
					...
					put(grammarAccess.getSquareAccess().getGroup_9(), "rule__Square__Group_9__0");
					put(grammarAccess.getSquareAccess().getGroup_11(), "rule__Square__Group_11__0");
					put(grammarAccess.getSquareAccess().getGroup_12(), "rule__Square__Group_12__0");
					put(grammarAccess.getSquareAccess().getGroup_13(), "rule__Square__Group_13__0");
					put(grammarAccess.getSquareAccess().getGroup_14(), "rule__Square__Group_14__0");
					...
					put(grammarAccess.getGradientAccess().getGroup_14(), "rule__Gradient__Group_14__0");
					put(grammarAccess.getGradientAccess().getGroup_15(), "rule__Gradient__Group_15__0");
					put(grammarAccess.getGradientAccess().getGroup_16(), "rule__Gradient__Group_16__0");
					...
					put(grammarAccess.getRelationBasedEdgeAccess().getGroup_6(), "rule__RelationBasedEdge__Group_6__0");
					put(grammarAccess.getRelationBasedEdgeAccess().getGroup_11(), "rule__RelationBasedEdge__Group_11__0");
					put(grammarAccess.getRelationBasedEdgeAccess().getGroup_11_1(), "rule__RelationBasedEdge__Group_11_1__0");
					put(grammarAccess.getRelationBasedEdgeAccess().getGroup_16(), "rule__RelationBasedEdge__Group_16__0");
					put(grammarAccess.getRelationBasedEdgeAccess().getGroup_16_1(), "rule__RelationBasedEdge__Group_16_1__0");
					...
					put(grammarAccess.getEdgeStyleAccess().getGroup_12(), "rule__EdgeStyle__Group_12__0");
					put(grammarAccess.getEdgeLabelAccess().getGroup(), "rule__EdgeLabel__Group__0");
					put(grammarAccess.getEdgeLabelAccess().getGroup_1(), "rule__EdgeLabel__Group_1__0");
					put(grammarAccess.getEdgeLabelAccess().getGroup_4(), "rule__EdgeLabel__Group_4__0");
					...
					put(grammarAccess.getViewpointAccess().getIconPathAssignment_1_2(), "rule__Viewpoint__IconPathAssignment_1_2");
					put(grammarAccess.getViewpointAccess().getNameAssignment_3(), "rule__Viewpoint__NameAssignment_3");
					put(grammarAccess.getViewpointAccess().getLabelAssignment_4_1(), "rule__Viewpoint__LabelAssignment_4_1");
					put(grammarAccess.getViewpointAccess().getModelFileExtensionsAssignment_6_3(), "rule__Viewpoint__ModelFileExtensionsAssignment_6_3");
					put(grammarAccess.getViewpointAccess().getModelFileExtensionsAssignment_6_4_1(), "rule__Viewpoint__ModelFileExtensionsAssignment_6_4_1");
					...
					put(grammarAccess.getDiagramAccess().getMetamodelUrisAssignment_4_2(), "rule__Diagram__MetamodelUrisAssignment_4_2");
					put(grammarAccess.getDiagramAccess().getMetamodelUrisAssignment_4_3_1(), "rule__Diagram__MetamodelUrisAssignment_4_3_1");
					put(grammarAccess.getDiagramAccess().getNameAssignment_6(), "rule__Diagram__NameAssignment_6");
					put(grammarAccess.getDiagramAccess().getLabelAssignment_7_1(), "rule__Diagram__LabelAssignment_7_1");
					put(grammarAccess.getDiagramAccess().getDomainClassAssignment_9(), "rule__Diagram__DomainClassAssignment_9");
					put(grammarAccess.getDiagramAccess().getPreconditionExpressionAssignment_10_1(), "rule__Diagram__PreconditionExpressionAssignment_10_1");
					put(grammarAccess.getDiagramAccess().getEndUserDocumentationAssignment_12_2(), "rule__Diagram__EndUserDocumentationAssignment_12_2");
					put(grammarAccess.getDiagramAccess().getTitleExpressionAssignment_13_2(), "rule__Diagram__TitleExpressionAssignment_13_2");
					put(grammarAccess.getDiagramAccess().getRootExpressionAssignment_14_2(), "rule__Diagram__RootExpressionAssignment_14_2");
					put(grammarAccess.getDiagramAccess().getDefaultLayerAssignment_15_2(), "rule__Diagram__DefaultLayerAssignment_15_2");
					put(grammarAccess.getDiagramAccess().getAdditionalLayersAssignment_16_3_0(), "rule__Diagram__AdditionalLayersAssignment_16_3_0");
					put(grammarAccess.getDiagramAccess().getAdditionalLayersAssignment_16_3_1_1(), "rule__Diagram__AdditionalLayersAssignment_16_3_1_1");
					put(grammarAccess.getLayerAccess().getDocumentationAssignment_0(), "rule__Layer__DocumentationAssignment_0");
					put(grammarAccess.getLayerAccess().getIconPathAssignment_1_2(), "rule__Layer__IconPathAssignment_1_2");
					put(grammarAccess.getLayerAccess().getNameAssignment_3(), "rule__Layer__NameAssignment_3");
					...
					put(grammarAccess.getSectionAccess().getIconPathAssignment_1_2(), "rule__Section__IconPathAssignment_1_2");
					put(grammarAccess.getSectionAccess().getNameAssignment_3(), "rule__Section__NameAssignment_3");
					put(grammarAccess.getSectionAccess().getLabelAssignment_4_1(), "rule__Section__LabelAssignment_4_1");
					...
					put(grammarAccess.getContainerCreationAccess().getIconPathAssignment_2_2(), "rule__ContainerCreation__IconPathAssignment_2_2");
					put(grammarAccess.getContainerCreationAccess().getNodeCreationVariableAssignment_3_2(), "rule__ContainerCreation__NodeCreationVariableAssignment_3_2");
					put(grammarAccess.getContainerCreationAccess().getContainerViewVariableAssignment_4_2(), "rule__ContainerCreation__ContainerViewVariableAssignment_4_2");
					put(grammarAccess.getContainerCreationAccess().getNameAssignment_6(), "rule__ContainerCreation__NameAssignment_6");
					put(grammarAccess.getContainerCreationAccess().getLabelAssignment_7_1(), "rule__ContainerCreation__LabelAssignment_7_1");
					put(grammarAccess.getContainerCreationAccess().getPreconditionExpressionAssignment_8_1(), "rule__ContainerCreation__PreconditionExpressionAssignment_8_1");
					put(grammarAccess.getContainerCreationAccess().getContainerMappingsAssignment_13_0(), "rule__ContainerCreation__ContainerMappingsAssignment_13_0");
					put(grammarAccess.getContainerCreationAccess().getContainerMappingsAssignment_13_1_1(), "rule__ContainerCreation__ContainerMappingsAssignment_13_1_1");
					put(grammarAccess.getContainerCreationAccess().getExtraMappingsAssignment_15_3_0(), "rule__ContainerCreation__ExtraMappingsAssignment_15_3_0");
					put(grammarAccess.getContainerCreationAccess().getExtraMappingsAssignment_15_3_1_1(), "rule__ContainerCreation__ExtraMappingsAssignment_15_3_1_1");
					put(grammarAccess.getContainerCreationAccess().getBodyAssignment_18(), "rule__ContainerCreation__BodyAssignment_18");
					...
					put(grammarAccess.getNodeAccess().getDocumentationAssignment_0(), "rule__Node__DocumentationAssignment_0");
					put(grammarAccess.getNodeAccess().getNameAssignment_2(), "rule__Node__NameAssignment_2");
					put(grammarAccess.getNodeAccess().getLabelAssignment_3_1(), "rule__Node__LabelAssignment_3_1");
					put(grammarAccess.getNodeAccess().getDomainClassAssignment_5(), "rule__Node__DomainClassAssignment_5");
					put(grammarAccess.getNodeAccess().getStyleAssignment_7(), "rule__Node__StyleAssignment_7");
					put(grammarAccess.getNodeAccess().getPreconditionExpressionAssignment_8_1(), "rule__Node__PreconditionExpressionAssignment_8_1");
					put(grammarAccess.getNodeAccess().getSemanticCandidatesExpressionAssignment_10_2(), "rule__Node__SemanticCandidatesExpressionAssignment_10_2");
					put(grammarAccess.getNodeAccess().getAssociatedElementsExpressionAssignment_11_2(), "rule__Node__AssociatedElementsExpressionAssignment_11_2");
					put(grammarAccess.getNodeAccess().getConditionalStylesAssignment_12(), "rule__Node__ConditionalStylesAssignment_12");
					put(grammarAccess.getContainerAccess().getDocumentationAssignment_0(), "rule__Container__DocumentationAssignment_0");
					put(grammarAccess.getContainerAccess().getChildrenPresentationAssignment_2(), "rule__Container__ChildrenPresentationAssignment_2");
					...
					put(grammarAccess.getContainerAccess().getPreconditionExpressionAssignment_9_1(), "rule__Container__PreconditionExpressionAssignment_9_1");
					put(grammarAccess.getContainerAccess().getSemanticCandidatesExpressionAssignment_11_2(), "rule__Container__SemanticCandidatesExpressionAssignment_11_2");
					put(grammarAccess.getContainerAccess().getAssociatedElementsExpressionAssignment_12_2(), "rule__Container__AssociatedElementsExpressionAssignment_12_2");
					put(grammarAccess.getContainerAccess().getConditionalStylesAssignment_13(), "rule__Container__ConditionalStylesAssignment_13");
					put(grammarAccess.getConditionalNodeStyleDeclarationAccess().getStyleAssignment_1(), "rule__ConditionalNodeStyleDeclaration__StyleAssignment_1");
					put(grammarAccess.getConditionalNodeStyleDeclarationAccess().getConditionalStyleExpressionAssignment_3(), "rule__ConditionalNodeStyleDeclaration__ConditionalStyleExpressionAssignment_3");
					...
					put(grammarAccess.getSquareAccess().getDocumentationAssignment_0(), "rule__Square__DocumentationAssignment_0");
					put(grammarAccess.getSquareAccess().getAllowVerticalResizingAssignment_1(), "rule__Square__AllowVerticalResizingAssignment_1");
					put(grammarAccess.getSquareAccess().getAllowHorizontalResizingAssignment_2(), "rule__Square__AllowHorizontalResizingAssignment_2");
					put(grammarAccess.getSquareAccess().getNameAssignment_4(), "rule__Square__NameAssignment_4");
					put(grammarAccess.getSquareAccess().getColorAssignment_6(), "rule__Square__ColorAssignment_6");
					put(grammarAccess.getSquareAccess().getLabelAssignment_8(), "rule__Square__LabelAssignment_8");
					put(grammarAccess.getSquareAccess().getLabelBorderStyleAssignment_9_2(), "rule__Square__LabelBorderStyleAssignment_9_2");
					put(grammarAccess.getSquareAccess().getBorderAssignment_10(), "rule__Square__BorderAssignment_10");
					put(grammarAccess.getSquareAccess().getHeightAssignment_11_2(), "rule__Square__HeightAssignment_11_2");
					put(grammarAccess.getSquareAccess().getWidthAssignment_12_2(), "rule__Square__WidthAssignment_12_2");
					put(grammarAccess.getSquareAccess().getSizeComputationExpressionAssignment_13_2(), "rule__Square__SizeComputationExpressionAssignment_13_2");
					put(grammarAccess.getSquareAccess().getTooltipExpressionAssignment_14_2(), "rule__Square__TooltipExpressionAssignment_14_2");
					put(grammarAccess.getLabelAccess().getShowIconAssignment_0(), "rule__Label__ShowIconAssignment_0");
					put(grammarAccess.getLabelAccess().getHideByDefaultAssignment_1(), "rule__Label__HideByDefaultAssignment_1");
					put(grammarAccess.getLabelAccess().getIconPathAssignment_2_2(), "rule__Label__IconPathAssignment_2_2");
					put(grammarAccess.getLabelAccess().getFormatOptionsAssignment_4(), "rule__Label__FormatOptionsAssignment_4");
					put(grammarAccess.getLabelAccess().getAlignmentAssignment_5(), "rule__Label__AlignmentAssignment_5");
					put(grammarAccess.getLabelAccess().getSizeAssignment_6_2(), "rule__Label__SizeAssignment_6_2");
					put(grammarAccess.getLabelAccess().getExpressionAssignment_7(), "rule__Label__ExpressionAssignment_7");
					put(grammarAccess.getLabelAccess().getColorAssignment_9(), "rule__Label__ColorAssignment_9");
					put(grammarAccess.getBorderAccess().getLineStyleAssignment_1(), "rule__Border__LineStyleAssignment_1");
					put(grammarAccess.getBorderAccess().getBorderSizeComputationExpressionAssignment_4(), "rule__Border__BorderSizeComputationExpressionAssignment_4");
					put(grammarAccess.getBorderAccess().getBorderColorAssignment_6(), "rule__Border__BorderColorAssignment_6");
					...
					put(grammarAccess.getGradientAccess().getLabelAssignment_9(), "rule__Gradient__LabelAssignment_9");
					put(grammarAccess.getGradientAccess().getLabelBorderStyleAssignment_10_2(), "rule__Gradient__LabelBorderStyleAssignment_10_2");
					put(grammarAccess.getGradientAccess().getBorderAssignment_11(), "rule__Gradient__BorderAssignment_11");
					...
					put(grammarAccess.getGradientAccess().getArcHeightAssignment_14_2(), "rule__Gradient__ArcHeightAssignment_14_2");
					put(grammarAccess.getGradientAccess().getArcWidthAssignment_15_2(), "rule__Gradient__ArcWidthAssignment_15_2");
					put(grammarAccess.getGradientAccess().getTooltipExpressionAssignment_16_2(), "rule__Gradient__TooltipExpressionAssignment_16_2");
					...
					put(grammarAccess.getRelationBasedEdgeAccess().getPreconditionExpressionAssignment_6_1(), "rule__RelationBasedEdge__PreconditionExpressionAssignment_6_1");
					put(grammarAccess.getRelationBasedEdgeAccess().getSourceMappingsAssignment_11_0(), "rule__RelationBasedEdge__SourceMappingsAssignment_11_0");
					put(grammarAccess.getRelationBasedEdgeAccess().getSourceMappingsAssignment_11_1_1(), "rule__RelationBasedEdge__SourceMappingsAssignment_11_1_1");
					put(grammarAccess.getRelationBasedEdgeAccess().getTargetMappingsAssignment_16_0(), "rule__RelationBasedEdge__TargetMappingsAssignment_16_0");
					put(grammarAccess.getRelationBasedEdgeAccess().getTargetMappingsAssignment_16_1_1(), "rule__RelationBasedEdge__TargetMappingsAssignment_16_1_1");
					put(grammarAccess.getRelationBasedEdgeAccess().getTargetFinderExpressionAssignment_20(), "rule__RelationBasedEdge__TargetFinderExpressionAssignment_20");
					...
					put(grammarAccess.getEdgeStyleAccess().getLabelAssignment_7(), "rule__EdgeStyle__LabelAssignment_7");
					put(grammarAccess.getEdgeStyleAccess().getSourceArrowAssignment_8_2(), "rule__EdgeStyle__SourceArrowAssignment_8_2");
					put(grammarAccess.getEdgeStyleAccess().getTargetArrowAssignment_9_2(), "rule__EdgeStyle__TargetArrowAssignment_9_2");
					put(grammarAccess.getEdgeStyleAccess().getSizeComputationExpressionAssignment_10_2(), "rule__EdgeStyle__SizeComputationExpressionAssignment_10_2");
					put(grammarAccess.getEdgeStyleAccess().getFoldingStyleAssignment_11_2(), "rule__EdgeStyle__FoldingStyleAssignment_11_2");
					put(grammarAccess.getEdgeStyleAccess().getEndsCenteringAssignment_12_2(), "rule__EdgeStyle__EndsCenteringAssignment_12_2");
					put(grammarAccess.getEdgeLabelAccess().getShowIconAssignment_0(), "rule__EdgeLabel__ShowIconAssignment_0");
					put(grammarAccess.getEdgeLabelAccess().getIconPathAssignment_1_2(), "rule__EdgeLabel__IconPathAssignment_1_2");
					put(grammarAccess.getEdgeLabelAccess().getFormatOptionsAssignment_3(), "rule__EdgeLabel__FormatOptionsAssignment_3");
					put(grammarAccess.getEdgeLabelAccess().getSizeAssignment_4_2(), "rule__EdgeLabel__SizeAssignment_4_2");
					put(grammarAccess.getEdgeLabelAccess().getExpressionAssignment_5(), "rule__EdgeLabel__ExpressionAssignment_5");
					put(grammarAccess.getEdgeLabelAccess().getColorAssignment_7(), "rule__EdgeLabel__ColorAssignment_7");
