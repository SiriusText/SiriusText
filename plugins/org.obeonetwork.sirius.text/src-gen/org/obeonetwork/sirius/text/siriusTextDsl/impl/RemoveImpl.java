 ...
 * </p>
 * <ul>
 *   <li>{@link org.obeonetwork.sirius.text.siriusTextDsl.impl.RemoveImpl#getBody <em>Body</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RemoveImpl extends OperationImpl implements Remove
{
  ...
  {
    return SiriusTextDslPackage.Literals.REMOVE;
  }
  ...
  public EList<Operation> getBody()
  {
    if (body == null)
    {
      body = new EObjectContainmentEList<Operation>(Operation.class, this, SiriusTextDslPackage.REMOVE__BODY);
    }
    return body;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SiriusTextDslPackage.REMOVE__BODY:
